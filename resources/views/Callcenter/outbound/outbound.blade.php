...
@section('maincontent')
        ...
        <div class="box-header">  
            ...
            <div class="btn-group pull-left">
                ...
                <div class="btn-group">
                <a id="btnAddNew" href="/outbounds/addnew" type="button" class="btn btn-primary pull-left" data-toggle="tooltip" title="{{ __('callcenter.newitem') }}" data-original-title="{{ __('callcenter.newitem') }}">{{ __('callcenter.newitem') }} <i class="fa fa-plus"></i></a>
                </div>
				@endif
        ...
        <!-- /.box-header -->
        <form id="frmList" method="POST" action="outbounds" data-toggle="validator" role="form">                                                           
            {{ csrf_field() }}
        <div class="box-body">
            ...
            <tr>
				...
				<th style='font-size: 13px; font-weight: bold; text-align: right'>نام مسیر</th>
                <th style='font-size: 13px; font-weight: bold; text-align: right'>زمان انقضاء</th>
                <th style='font-size: 13px; font-weight: bold; text-align: right'>آدرس مقصد</th>
                <th style='font-size: 13px; font-weight: bold; text-align: right'>آدرس پراکسی</th>                                                          
				<th style='font-size: 14px; font-weight: bold; text-align: right'>احراز هویت</th> 
            ...
            <tbody>                
                <?php foreach ($datalist as $item) { ?>
                    <tr>
                        ...
                        <input type="checkbox" name="selected[]" value="<?php echo $item->o_id; ?>" />
                        </td>                                                                  
						<td class="text-right"><?php echo $item->o_id; ?> </td>     
                        <td class="text-right"><?php echo $item->o_name; ?> </td> 
                        <td class="text-right"><?php echo $item->o_timeout; ?> </td> 
                        <td class="text-right"><?php echo $item->o_ipaddress; ?> </td>                                                                                                         
						<td class="text-right"><?php echo $item->o_proxy; ?> </td> 
						<td class="text-right"><?php echo ($item->o_registering=="on"?"بله":"خیر"); ?> </td> 
						<td class="text-right"><?php echo $item->o_username; ?> </td> 
                    </tr>                    
                <?php } ?>
            </tbody>             
            </table>
    ...
    <script>
        ...
        $(document).ready(function(){            
            $("#lnkEdit").click(function(){
                ...
                if(item_id!=''){
                    window.location = "/outbounds/edit/"+item_id;    
                }
            });       
        });
		@endif
