...
@section('pageheadercontent')
      <h1>
        ...
        <small>سرورهای تلفنی</small>
      </h1>	  
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> خانه</a></li>
        <li><a href="#">مرکز تماس</a></li>
        <li class="active">سرورهای تلفنی</li>
      </ol>    
@endsection
...
@section('maincontent')
        ...
        <div class="box-header">  
            ...
            <div class="btn-group pull-left">
                ...
                <div class="btn-group">
                <a id="btnAddNew" href="/server/addnew" type="button" class="btn btn-primary pull-left" data-toggle="tooltip" title="{{ __('callcenter.newitem') }}" data-original-title="{{ __('callcenter.newitem') }}">{{ __('callcenter.newitem') }} <i class="fa fa-plus"></i></a>
                </div>
				@endif
        ...
        <div class="box-body">
            ...
            <tr>
				...
				<th style='font-size: 13px; font-weight: bold; text-align: right'>نام سرور</th>                
				<th style='font-size: 14px; font-weight: bold; text-align: right'>دامنه</th> 
            </tr>
            </thead>
            <tbody>                
    ...
    <script>
        ...
        $(document).ready(function(){            
            $("#lnkEdit").click(function(){
                ...
                if(item_id!=''){
                    window.location = "/server/edit/"+item_id;    
                }
            });       
        });
		@endif
