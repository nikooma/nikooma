...
@section('maincontent')		
	<div class="box box-info">		
		<a href="/sound" class="btn btn-primary pull-left" style="margin:10px;">بازگشت <i class="fa fa-reply"></i></a>              
		<hr />
		<div class="box-body center-frame">
		  <form method="POST" action="/sound" enctype="multipart/form-data">                                                           
			{{ csrf_field() }}
			نام صدا:
			...
			<div class="fileupload fileupload-new" data-provides="fileupload">
				<label class="file-upload btn btn-primary">
					Browse for file ... <input type="file" id="sound" name="flesound" />
				</label>
			 </div>
			<br />
