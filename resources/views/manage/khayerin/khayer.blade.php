...
@section('maincontent')
        ...
        <div class="box-header">  
            ...
            <div class="btn-group pull-left">
                ...
                <div class="btn-group">
                <a id="btnAddNew" href="/khayer/addnew" type="button" class="btn btn-primary pull-left" data-toggle="tooltip" title="{{ __('callcenter.newitem') }}" data-original-title="{{ __('callcenter.newitem') }}">{{ __('callcenter.newitem') }} <i class="fa fa-plus"></i></a>
                </div>
				@endif
        ...
        <!-- /.box-header -->
        <form id="frmList" method="POST" action="/khayer" data-toggle="validator" role="form">                                                           
            {{ csrf_field() }}
        <div class="box-body">
            ...
            <tr>
                ...
                <th style='font-weight: bold; text-align: right'>آدرس</th> 				
            </tr>
            </thead>
            <tbody>                
                <?php foreach ($datalist as $item) { ?>
                    <tr>
                        ...
                        <input type="checkbox" name="selected[]" value="<?php echo $item->kh_id; ?>" />
                        </td>                                           						  
                        <td class="text-right"><?php echo $item->kh_name.' '.$item->kh_family; ?> </td> 
						<td class="text-right"><?php echo $item->kh_mobile; ?> </td>  
                        <td class="text-right"><?php echo $item->kh_shoghl; ?> </td> 												
                        <td class="text-right"><?php echo $item->kh_address; ?> </td>                         
                    </tr>                    
                <?php } ?>
            </tbody>             
            </table>
		...
		<form id="frmExport" name="frmexport" method="POST" action="/khayer" data-toggle="validator" role="form">
			{{ csrf_field() }}
		...
		<form method="POST" name="frmimport" action="/khayer" enctype="multipart/form-data">
			{{ csrf_field() }}
    ...
    <script>
        ...
        $(document).ready(function(){    			
            $("#lnkEdit").click(function(){
                ...
                if(item_id!=''){
                    window.location = "/khayer/edit/"+item_id;    
                }
            });       		           
